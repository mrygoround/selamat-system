  ...
  try {
    ...
    Connection conn = DriverManager.getConnection(url);
      ...
      if ("create".equalsIgnoreCase(action)) {
        ...
        if (name != null && email != null && shelterIdStr != null && startDate != null && endDate != null && peopleStr != null) {
          int shelterId = Integer.parseInt(shelterIdStr);
          int people = Integer.parseInt(peopleStr);

          PreparedStatement pst = conn.prepareStatement(
              "INSERT INTO BOOKING (NAME, EMAIL, SHELTER_ID, START_DATE, END_DATE, PEOPLE, STATUS) VALUES (?, ?, ?, ?, ?, ?, ?)");
